...
{
    class TimedNetworkedLevel : Scene
    {
        ...
        public override void Update(GameTime gametime)
        {
            ...
            Engine.Network.WriteTimerPacket(timer.StartTimer);
        ...
        public void ReadTimerPacket()
        {
            timer.StartTimer = Engine.Network.PacketReader.ReadInt32();
        }
        ...
        public void ReadMovePacket()
        {
            ...
            MoveOtherPiece(pos,fromSq, toSq);
        }
