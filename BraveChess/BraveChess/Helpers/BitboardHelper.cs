...
namespace BraveChess
{
    class BitboardHelper
    {
        ...
        public static ulong[] magicNumberRook = new ulong[]{
        ...
        public static int[] magicNumberShiftsBishop = new int[] { 58,59,59,59,59,59,59,58,
        ...
        int CountSetBits(UInt64 x) //ref:http://en.wikipedia.org/wiki/Hamming_weight
        {
            int count;
        ...
        int[] GetSetBits(UInt64 x) //return array holding index of each bit set in UInt64 x
        {
        ...
        public void generateOccupancyVariations(bool isRook) 
    {
        ...
        for (bitRef=0; bitRef<=63; bitRef++)
        {
            ...
            for (i=0; i<variationCount; i++)
            {
                ...
                setBitsInIndex = GetSetBits((uint)i); 
